...
def test_callback_authorization_is_deny_by_default() -> None:
    ...
    assert is_public_callback("connection_guides")
    assert is_public_callback("connection_guide_abcdef123456")
    assert not is_public_callback("settings_connection_guides")
