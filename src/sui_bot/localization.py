...
RENEWAL_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "display_name_label": "🤖 Display name", "set_display_name": "🤖 Set display name",
        "enter_display_name": "Enter a new display name (2-48 characters).\n\nCancel: /cancel",
        ...
        "display_name_profile_failed": "⚠️ Message branding was saved, but Telegram could not update the profile name yet. It will retry after restart.",
    ...
    "fa": {
        ...
        "display_name_label": "🤖 نام نمایشی", "set_display_name": "🤖 تنظیم نام نمایشی",
        "enter_display_name": "نام نمایشی جدید را وارد کنید (۲ تا ۴۸ نویسه).\n\nلغو: /cancel",
        "display_name_updated": "✅ نام نمایشی به {name} تغییر کرد.",
        "display_name_invalid": "❌ یک نام نمایشی شامل ۲ تا ۴۸ نویسه قابل مشاهده وارد کنید.",
        "display_name_profile_failed": "⚠️ نام نمایشی پیام‌ها ذخیره شد، اما تلگرام هنوز نتوانست نام نمایه را تغییر دهد. پس از راه‌اندازی مجدد دوباره تلاش می‌شود.",
    ...
    "ru": {
        ...
        "display_name_label": "🤖 Отображаемое имя", "set_display_name": "🤖 Изменить отображаемое имя",
        "enter_display_name": "Введите новое отображаемое имя (2–48 символов).\n\nОтмена: /cancel",
        "display_name_updated": "✅ Отображаемое имя изменено на: {name}",
        "display_name_invalid": "❌ Введите отображаемое имя из 2–48 видимых символов.",
        "display_name_profile_failed": "⚠️ Имя в сообщениях сохранено, но Telegram пока не изменил имя профиля. После перезапуска будет выполнена новая попытка.",
    ...
    "zh": {
        ...
        "display_name_label": "🤖 显示名称", "set_display_name": "🤖 设置显示名称",
        "enter_display_name": "请输入新的显示名称（2–48 个字符）。\n\n取消：/cancel",
        "display_name_updated": "✅ 显示名称已更新为：{name}",
        "display_name_invalid": "❌ 请输入包含 2–48 个可见字符的显示名称。",
        "display_name_profile_failed": "⚠️ 消息中的品牌名称已保存，但 Telegram 尚未更新资料名称；重启后会再次尝试。",
