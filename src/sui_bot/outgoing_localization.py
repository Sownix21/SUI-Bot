...
PHRASES: dict[str, dict[str, str]] = {
    "fa": {
        "Cancel Interactive Assignment": "لغو اتصال تعاملی", "Interactive Assignment": "اتصال تعاملی",
        "Choose Telegram Account": "انتخاب حساب تلگرام", "Confirm Assignment": "تأیید اتصال", "Assign Another": "اتصال کاربر دیگر",
        "Start Expiry On First Connection": "شروع انقضا از اولین اتصال", "Expiry Countdown Already Started": "شمارش انقضا از اکنون",
        "Auto-reset Usage From First Connection": "بازنشانی خودکار مصرف از اولین اتصال", "Auto-reset Usage From Now": "بازنشانی خودکار مصرف از اکنون",
        "Keep Current Policy": "حفظ سیاست فعلی", "Choose the expiry/reset policy": "سیاست انقضا و بازنشانی را انتخاب کنید",
        "Enter an administrative remark": "یادداشت مدیریتی را وارد کنید", "Enter a new administrative remark": "یادداشت مدیریتی جدید را وارد کنید",
        "Remark must be at most": "حداکثر طول یادداشت", "Remark": "یادداشت", "Policy": "سیاست",
        "Set Administrative Timezone": "تنظیم منطقه زمانی مدیریت", "Administrative Timezone": "منطقه زمانی مدیریت",
        "Set Exact Monthly Price": "تنظیم دقیق قیمت ماهانه", "Set Currency": "تنظیم واحد پول", "Payment Currency": "واحد پول پرداخت", "Currency": "واحد پول",
        ...
        "Payments & Renewal": "پرداخت‌ها و تمدید", "Administration": "مدیریت", "Choose a category": "یک دسته را انتخاب کنید",
    ...
    "ru": {
        "Cancel Interactive Assignment": "Отменить интерактивную привязку", "Interactive Assignment": "Интерактивная привязка",
        "Choose Telegram Account": "Выбрать аккаунт Telegram", "Confirm Assignment": "Подтвердить привязку", "Assign Another": "Привязать ещё",
        "Start Expiry On First Connection": "Запустить срок при первом подключении", "Expiry Countdown Already Started": "Срок уже отсчитывается",
        "Auto-reset Usage From First Connection": "Автосброс трафика с первого подключения", "Auto-reset Usage From Now": "Автосброс трафика с текущего момента",
        "Keep Current Policy": "Сохранить текущую политику", "Choose the expiry/reset policy": "Выберите политику срока и сброса",
        "Enter an administrative remark": "Введите заметку администратора", "Enter a new administrative remark": "Введите новую заметку администратора",
        "Remark must be at most": "Максимальная длина заметки", "Remark": "Заметка", "Policy": "Политика",
        "Set Administrative Timezone": "Указать часовой пояс администратора", "Administrative Timezone": "Часовой пояс администратора",
        "Set Exact Monthly Price": "Указать точную месячную цену", "Set Currency": "Указать валюту", "Payment Currency": "Валюта платежа", "Currency": "Валюта",
        ...
        "Payments & Renewal": "Платежи и продление", "Administration": "Администрирование", "Choose a category": "Выберите категорию",
    ...
    "zh": {
        "Cancel Interactive Assignment": "取消交互式绑定", "Interactive Assignment": "交互式绑定",
        "Choose Telegram Account": "选择 Telegram 账户", "Confirm Assignment": "确认绑定", "Assign Another": "继续绑定",
        "Start Expiry On First Connection": "首次连接后开始到期倒计时", "Expiry Countdown Already Started": "到期倒计时已开始",
        "Auto-reset Usage From First Connection": "首次连接后自动重置流量", "Auto-reset Usage From Now": "从现在开始自动重置流量",
        "Keep Current Policy": "保留当前策略", "Choose the expiry/reset policy": "选择到期与重置策略",
        "Enter an administrative remark": "输入管理员备注", "Enter a new administrative remark": "输入新的管理员备注",
        "Remark must be at most": "备注最大长度", "Remark": "备注", "Policy": "策略",
        "Set Administrative Timezone": "设置管理员时区", "Administrative Timezone": "管理员时区",
        "Set Exact Monthly Price": "设置准确月费", "Set Currency": "设置货币", "Payment Currency": "支付货币", "Currency": "货币",
        ...
        "Payments & Renewal": "付款与续订", "Administration": "管理工具", "Choose a category": "请选择类别",
...
STRICT_UI_PHRASES = {
    "fa": {
        ...
        "This is optional and separate from the user description.": "این بخش اختیاری و جدا از توضیحات کاربر است.",
        ...
        "With Telegram Links": "دارای اتصال تلگرام", "Without Telegram Links": "بدون اتصال تلگرام",
        "Users Without Telegram Links": "کاربران بدون اتصال تلگرام", "Stats": "آمار",
        "Active Users": "کاربران فعال", "Inactive Users (Haven't Started The Bot)": "کاربران غیرفعال (ربات را شروع نکرده‌اند)",
        "All Linked Users Started The Bot.": "همه کاربران متصل، ربات را شروع کرده‌اند.",
        "Users Without Link": "کاربران بدون اتصال", "All Users Are Linked.": "همه کاربران متصل هستند.",
        "Days Left": "روز باقی مانده", "Day Left": "روز باقی مانده", "Other User": "کاربر دیگر",
        "Backup rejected": "پشتیبان رد شد", "Auto-unlinked from": "اتصال خودکار از",
        "Telegram user(s)": "کاربر تلگرام", "Detected": "شناسایی شد:",
        "expired subscription(s)": "اشتراک منقضی‌شده", "Still Enable": "هنوز فعال",
        "Need To Check Manually To Disable": "برای غیرفعال‌سازی باید دستی بررسی شود", "Edit Users": "ویرایش کاربران",
        "Auto-Cleanup Report": "گزارش پاک‌سازی خودکار", "Removed IDs": "شناسه‌های حذف‌شده",
        "deleted client ID(s) from Telegram assignments": "شناسه کاربر حذف‌شده از اتصال‌های تلگرام",
        "more user(s)": "کاربر دیگر", "Time": "زمان", "Running Time": "مدت اجرا",
        "Time Running": "مدت اجرا", "Most Used Commands": "پرکاربردترین فرمان‌ها",
        "Average Response Time": "میانگین زمان پاسخ", "Command": "فرمان", "Times": "بار",
        "Disabled": "غیرفعال", "Removed": "حذف شد:", "... and": "... و",
        "All Commands": "همه فرمان‌ها", "All Errors": "همه خطاها", "Hour": "ساعت", "Minute": "دقیقه",
    },
    "ru": {
        ...
        "This is optional and separate from the user description.": "Это необязательное поле, отдельное от описания пользователя.",
        ...
        "With Telegram Links": "С привязкой Telegram", "Without Telegram Links": "Без привязки Telegram",
        "Users Without Telegram Links": "Пользователи без привязки Telegram", "Stats": "Статистика",
        "Active Users": "Активные пользователи", "Inactive Users (Haven't Started The Bot)": "Неактивные пользователи (бот не запущен)",
        "All Linked Users Started The Bot.": "Все привязанные пользователи запустили бота.",
        "Users Without Link": "Пользователи без привязки", "All Users Are Linked.": "Все пользователи привязаны.",
        "Days Left": "дн. осталось", "Day Left": "день остался", "Other User": "другой пользователь",
        "Backup rejected": "Резервная копия отклонена", "Auto-unlinked from": "Автоматически отвязано от",
        "Telegram user(s)": "пользователей Telegram", "Detected": "Обнаружено:",
        "expired subscription(s)": "просроченных подписок", "Still Enable": "ещё включены",
        "Need To Check Manually To Disable": "Требуется ручная проверка и отключение", "Edit Users": "Изменить пользователей",
        "Auto-Cleanup Report": "Отчёт автоочистки", "Removed IDs": "Удалённые ID",
        "deleted client ID(s) from Telegram assignments": "удалённых ID клиентов из привязок Telegram",
        "more user(s)": "других пользователей", "Time": "Время", "Running Time": "Время работы",
        "Time Running": "Время работы", "Most Used Commands": "Самые используемые команды",
        "Average Response Time": "Среднее время ответа", "Command": "Команда", "Times": "раз",
        "Disabled": "отключены", "Removed": "Удалено:", "... and": "... и",
        "All Commands": "Всего команд", "All Errors": "Всего ошибок", "Hour": "ч.", "Minute": "мин.",
        "Unexpected error occurred": "Произошла непредвиденная ошибка",
        "Send the backup as a document, or use /cancel.": "Отправьте резервную копию как документ или используйте /cancel.",
        "Backup file is too large": "Файл резервной копии слишком большой",
        "Validating and restoring backup": "Проверка и восстановление резервной копии",
        "Backup restore canceled": "Восстановление резервной копии отменено",
        "Enter new card number": "Введите новый номер карты", "Enter new card holder name": "Введите имя нового владельца карты",
        "Card number updated to": "Номер карты изменён на", "Holder name too long": "Имя владельца слишком длинное",
        "Settings edit canceled": "Изменение настроек отменено", "added to Telegram ID": "добавлен к Telegram ID",
        "already assigned to Telegram ID": "уже привязан к Telegram ID", "View Links": "Просмотреть ссылки",
        "All links for Telegram ID": "Все привязки Telegram ID", "No links for Telegram ID": "Нет привязок для Telegram ID",
        "unlinked from Telegram ID": "отвязан от Telegram ID", "not assigned to this user": "не привязан к этому пользователю",
        "Description Must Be At Most": "Максимальная длина описания", "Group must be at most": "Максимальная длина группы",
        "New Name Registered": "Новое имя сохранено", "To Keep Current Volume Input": "Чтобы сохранить текущий объём, введите",
        "To Keep Current Expiry Input": "Чтобы сохранить текущий срок, введите",
        "Regenerate creates new passwords/UUIDs.": "Повторная генерация создаёт новые пароли/UUID.",
        "Keep Existing preserves current config credentials.": "Сохранение текущих секретов оставляет существующие учётные данные конфигурации.",
        "Implementing Changes": "Применение изменений", "Yes,Delete It": "Да, удалить",
        "Client ID Not Found": "ID клиента не найден", "Operation Deleting User Aborted": "Удаление пользователя отменено",
        "Live bot and S-UI tokens are intentionally excluded.": "Активные токены бота и S-UI намеренно исключены.",
        "Send /restore": "Отправьте /restore", "No subscription selected": "Подписка не выбрана",
        "Failed To Get Online Users List": "Не удалось получить список пользователей онлайн",
        "Failed To Get Users List": "Не удалось получить список пользователей", "Return To List": "Вернуться к списку",
        "Yes,Send": "Да, отправить", "Add New Link": "Добавить новую привязку", "Continue To Send": "Перейти к отправке",
        "Send the backup as a document, or use": "Отправьте резервную копию как документ или используйте",
        "Send": "Отправьте", "deleted": "удалены",
    },
    "zh": {
        ...
        "This is optional and separate from the user description.": "此项为可选内容，与用户描述相互独立。",
        ...
        "With Telegram Links": "已绑定 Telegram", "Without Telegram Links": "未绑定 Telegram",
        "Users Without Telegram Links": "未绑定 Telegram 的用户", "Stats": "统计",
        "Active Users": "活跃用户", "Inactive Users (Haven't Started The Bot)": "非活跃用户（尚未启动机器人）",
        "All Linked Users Started The Bot.": "所有已绑定用户都已启动机器人。",
        "Users Without Link": "未绑定用户", "All Users Are Linked.": "所有用户均已绑定。",
        "Days Left": "天剩余", "Day Left": "天剩余", "Other User": "其他用户",
        "Backup rejected": "备份被拒绝", "Auto-unlinked from": "已自动解除绑定：",
        "Telegram user(s)": "位 Telegram 用户", "Detected": "检测到：",
        "expired subscription(s)": "个已过期订阅", "Still Enable": "仍处于启用状态",
        "Need To Check Manually To Disable": "需要手动检查并禁用", "Edit Users": "编辑用户",
        "Auto-Cleanup Report": "自动清理报告", "Removed IDs": "已移除的 ID",
        "deleted client ID(s) from Telegram assignments": "个已删除客户端 ID 的 Telegram 绑定",
        "more user(s)": "位其他用户", "Time": "时间", "Running Time": "运行时间",
        "Time Running": "运行时间", "Most Used Commands": "最常用命令",
        "Average Response Time": "平均响应时间", "Command": "命令", "Times": "次",
        "Disabled": "已禁用", "Removed": "已移除：", "... and": "... 以及",
        "All Commands": "命令总数", "All Errors": "错误总数", "Hour": "小时", "Minute": "分钟",
        "Unexpected error occurred": "发生意外错误",
        "Send the backup as a document, or use /cancel.": "请以文档形式发送备份，或使用 /cancel。",
        "Backup file is too large": "备份文件过大", "Validating and restoring backup": "正在验证并恢复备份",
        "Backup restore canceled": "备份恢复已取消", "Enter new card number": "请输入新卡号",
        "Enter new card holder name": "请输入新的持卡人姓名", "Card number updated to": "卡号已更新为",
        "Holder name too long": "持卡人姓名过长", "Settings edit canceled": "设置编辑已取消",
        "added to Telegram ID": "已添加到 Telegram ID", "already assigned to Telegram ID": "已绑定到 Telegram ID",
        "View Links": "查看绑定", "All links for Telegram ID": "Telegram ID 的所有绑定",
        "No links for Telegram ID": "Telegram ID 没有绑定", "unlinked from Telegram ID": "已从 Telegram ID 解除绑定",
        "not assigned to this user": "未绑定到此用户", "Description Must Be At Most": "描述长度最多为",
        "Group must be at most": "分组长度最多为", "New Name Registered": "新名称已保存",
        "To Keep Current Volume Input": "要保留当前流量，请输入", "To Keep Current Expiry Input": "要保留当前有效期，请输入",
        "Regenerate creates new passwords/UUIDs.": "重新生成会创建新的密码和 UUID。",
        "Keep Existing preserves current config credentials.": "保留现有密钥会继续使用当前配置凭据。",
        "Implementing Changes": "正在应用更改", "Yes,Delete It": "是，删除",
        "Client ID Not Found": "未找到客户端 ID", "Operation Deleting User Aborted": "删除用户操作已取消",
        "Live bot and S-UI tokens are intentionally excluded.": "当前机器人和 S-UI 令牌会被有意排除。",
        "Send /restore": "发送 /restore", "No subscription selected": "未选择订阅",
        "Failed To Get Online Users List": "无法获取在线用户列表", "Failed To Get Users List": "无法获取用户列表",
        "Return To List": "返回列表", "Yes,Send": "是，发送", "Add New Link": "添加新绑定",
        "Continue To Send": "继续发送", "Send the backup as a document, or use": "请以文档形式发送备份，或使用",
        "Send": "发送", "deleted": "已删除",
    },
}
